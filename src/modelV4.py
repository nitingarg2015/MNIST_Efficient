...
class MNISTModel(nn.Module):
    def __init__(self, dropout_rate = 0):
        ...
        self.conv4 = nn.Conv2d(8, 16, kernel_size=3, padding=0)         #RF: 10, nout: 12
        self.bn4 = nn.BatchNorm2d(16)
        self.dropout4 = nn.Dropout(dropout_rate)
        self.conv5 = nn.Conv2d(16, 16, kernel_size=3, padding=0)        #RF: 14, nout: 10
        self.bn5 = nn.BatchNorm2d(16)
        self.dropout5 = nn.Dropout(dropout_rate)

        self.maxpool2 = nn.MaxPool2d(2, 2)                              #RF: 16, nout: 5
        self.ant2 = nn.Conv2d(16,8,kernel_size=1)                       #RF: 16, nout: 5

        self.conv6 = nn.Conv2d(8, 10, kernel_size=3, padding=0)         #RF: 24, nout: 5
        # self.bn6 = nn.BatchNorm2d(10)         
        # self.dropout6 = nn.Dropout(dropout_rate)
        # self.conv7 = nn.Conv2d(10, 10, kernel_size=3, padding=0)       #RF: 24, nout: 3
        self.avgpool = nn.AvgPool2d(2, 2)                               #RF: 28, nout: 1
